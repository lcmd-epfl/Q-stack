...
def test_hf_otpd():
    ...
    mol = compound.xyz_to_mol('data/H2O.xyz', 'def2svp', charge=0, spin=0)
    ...
    g  = basis_opt.opt.optimize_basis(['H'], ['data/initial/H_N0.txt', 'data/initial/O_N0.txt'], [mol_dict], check=True, printlvl=0)
    ...
    ob = basis_opt.opt.optimize_basis(['H'], ['data/initial/H_N0.txt'], ['data/H2.ccpvtz.grid3.npz'], printlvl=2, gtol_in=1e-5)
